...
//    부모인 MyInter 에서 상속받은 메소드는 추상메소드 method1(), 디폴트 메소드 method3()임
//    추상 메소드는 자식 클래스에서 반드시 오버라이딩하여 구현 해야함.
//    디폴트 메소드는 일반적인 메소드 이기 때문에 오버라이딩을 하지 않아도 상관없음
...
//    method3()은 인터페이스에서 상속받은 디폴트 메소드이므로 그냥사용하거나 오버라이딩해서 사용가능
//    @Override
//    public void method3(){
