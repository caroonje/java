...
//    StaticTest 클래스에서 copy() 메소드를 사용하고 있으므로 접근제한자가 public 혹은 default 임
...
//    StaticTest 클래스에서 equals() 메소드를 사용하고 있으므로 접근제한자가 public 혹은 default임
//    위 소스에서 equals() 메소드가 객체 생성없이 사용되고 있으므로 정적 메소드임
