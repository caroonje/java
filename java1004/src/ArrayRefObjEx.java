...
//        배열의 요소가 기본타입인 배열은 각각의 index에 값이 들어감
        System.out.println("\n----- 기본 타입 배열 생성 -----\n");
...
//        배열의 요소가 참조 타입인 배열 생성 방식은 기본타입의 배열 생성 방식과 동일함
...
//        참조 타입을 요소로 가지는 배열은 생성만하고 데이터를 저장을 하지 않았을 경우 초기값으로 null이 들어가있음


        String[] strArr3 = new String[3];
        System.out.println(strArr3);
//        String 타입으로 배열을 만들었다고 해서 초기값으로 ""이 들어가 있는것이 아니라 null이 들어가있음
        System.out.println(strArr3[0]);

        strArr3[0] = "java";
        strArr3[1] = "java";
        strArr3[2] = new String("java");
//        String 타입은 클래스 타입이기 때문에 new String() 방식으로 문자열을 생성시 힙 메모리 영역에 새로 데이터를 저장
