...
//    -매개변수와 필드의 이름이 같을 경우 컴파일러는 어떤 것이 매개변수이고,어떤 것이 필드인지 구별하지 못하기 때문에 각각의 필드와 매개변수를 명확하게 하기위해서 사용함
//    -매개변수와 필드의 이름이 같지 않을 경우 this 생략 가능

//    this(매개변수) : 하나의 생성자가 생성자 오버로딩으로 만들어진 다른 생성자를 호출하기 위한 명령어
//    -this()는 반드시 생성자의 첫번째 실행줄이어야 함

//    생성자 오버로딩을 통해서 필드를 초기화 할 경우 비슷한 소스 코드가 중복됨
//    this()를 사용하여 중복된 소스 코드의 중복을 제거할 수 있음
