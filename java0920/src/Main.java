...
//        단순if문 : 기존 소스코드의 흐름대로 모두 실행하다가 단순if문을 만날경우 조건식의 결과에 따라 추가적으로 실행을 하는 if문
//        --추가 옵션으로 생각하면 됨
//        사용법:
//        if(조건식){
...
//      int타입의 변수 score선언과 동시에 정수 데이터 95를 저장
        int score = 95;
...
//    중국집에 가서 짜장면을 먹는 상황이다
//    짜장면 7,000원, 군만두 5.000원
...
//        -단순 if 문 혹은 if~ else문이 여러개 있는 것과는 다름
//        사용법 :
//        if(조건식1){
//        조건식 1의 결과가 true일 경우 실행할 소스코드...
//        }
//        else if(조건식 2){
//        조건식 2의 결과가 true일 경우 실행할 소스코드...
//        }
//        else if(조건식 n){
//        조건식 n의 결과가 true일 경우 실행할 소스코드...
//        }
//        else {
//        모든 조건식의 결과가 false 일 경우 실핼할 소스코드...
//        }
...
//        모든 조건식을 다 입력했을 경우
        ...
        System.out.println("점수는 " + score + "점이고,등급" + level);

//      조건식은 순차적으로 입력해야 함
        System.out.println("\n-----else if 문의 조건식을 순차적으로 입력하지 않을 경우 -----\n");

        score = 85;
        level = "F";//등급의 기본값을 F로 설정
//        조건식이 90 비교 후 70 비교를 진행하고 80 비교를 진행함
//        문법적으로 오류가 있지는 않음
//        논리적으로 오류가 있을수 있음
//        순차적으로 조건식을 만들어야 함
        if (score >= 90) {
        ...
        System.out.println("\n-----중첩 if문 사용-----\n");
//        중첩if 문 :if문 안에 if문을 추가로 사용하는 if문
