...
//        -필드,메소드에 static 키워드를 사용하여 정적멤버로 선언
//        -객체 생성 없이 클래스를 통해서 직접 접근이 가능
//        -데이터를 서로 공유하고 있음
//        정적 멤버를 활욜
//        정적 멤버는 클래스 이름을 통하여 접근할 수 있음
...
//       정적 필드는 데이터를 공유한다,메모리 저장 공간이 같기 때문에 마지막에 저장된 데이터가 출력됨
        ...
        System.out.println("num2의 정적 필드 값 : " + Numbers.staticNum1 );
        System.out.println("num2의 정적 필드 값 : " + Numbers.staticNum2 );
