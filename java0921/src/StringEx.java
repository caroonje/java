...
//        - 대입 연산자를 사용한 문자열 변수 선언과 new키워드를 사용한 문자열 변수 선언은 사용하는 방식은 동일하지만 메모리 상에서 동작하는 형태가 다름


//        사용법 : 선언
//        String 변수명; //문자열 변수 선언만 함
//        String 변수명 = "문자열데이터"; //문자열 변수 선언 및 데이터 저장
//        String 변수명 = new String ("문자열데이터"); //문자열 변수 선언 및 데이터 저장
...
//        String 타입은 워낙 많이 사용하기 때문에 기본 타입처럼 사용할 수 있도록 설계
        ...
        System.out.println("\n----- 기본타입 형태로 사용할 때와 객체 형태로 사용시 다른 점 -----\n");
...
//        String타입은 원래 클래스 타입이기 때문에 new키워드를 사용하는 것이 기본
//        String타입은 사용의 편의성을 위해서 기본 데이터 타입처럼사용하도록 설계
//        동일한 코드 블럭 내에서 String타입의 변수를 2개이상 선언하고 , 동일한 문자열을 대입연산자(=)를 통해서 데이터를 입력 시 두 String타입의 변수는 동일한 String타입의 객체 주소를 참조함
//        new키워드 사용하여 String 타입 변수를 생성시 메모리 영역에 새로 데이터 공간을 생성함
//        new키워드 사용 시 String 타입의 변수에 저장된 실제 문자열이 같더라도 메모리 상의 주소가 다르기 때문에 서로가 다르다고 표현함
...
//        -동일한 문자열 일 경우 true, 다른 문자열일 경우 false를 출력
